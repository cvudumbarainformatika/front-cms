...
const form = reactive({
  title: '', slug: '', description: '<p>Deskripsi agenda...</p>', image: '', type: 'webinar', date: '', endDate: '', isOnline: false, location: '', fee: '', skp: 0, quota: 0, registered: 0, registrationUrl: '', status: 'draft' as 'draft'|'published'
})
...
async function save(status?: 'draft'|'published') {
  ...
  saving.value = true
  try {
    const res: any = await $fetch('/api/agenda', { method: 'POST', body: form })
