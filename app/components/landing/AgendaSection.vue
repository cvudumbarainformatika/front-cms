...
<template>
  <UPageSection id="agenda" class="py-24 bg-linear-to-r from-blue-900 via-sky-800 to-emerald-600 text-white rounded-t-[3rem] -mt-12 relative z-10">
